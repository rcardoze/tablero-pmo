...
function renderFooter() {
  ...
  f.replaceChildren(
    ...[
      h('div', null, 'Fuente: Monday.com. GitHub actualiza los datos solo varias veces al día (no a hora fija) y esta página los recarga sola cada minuto, sin necesidad de refrescar.'),
